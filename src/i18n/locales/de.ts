...
export const de = {
  ...
  hero: {
    eyebrow: 'Zukunftsorientiertes Engineering',
    heading1: 'Präzisionstechnik.',
    heading2: 'Beschleunigtes Wachstum.',
    body: 'Wir navigieren die Komplexität moderner Industriesysteme durch fortschrittliche Simulation, Strukturanalyse und maßgeschneiderte Fertigungsintelligenz.',
